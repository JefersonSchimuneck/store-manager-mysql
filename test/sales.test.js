    ...
    it('Será validado que é possível listar uma determinada venda', async () => {
      ...
      await frisby
        ...
        .then((responseOne) => {
          ...
          const saleIdFirstProduct = responseAll.sale[0].id;
          const saleIdSecondProduct = responseAll.sale[1].id;
          const productIdFirstProduct = responseAll.sale[0].product_id;
          const productIdSecondProduct = responseAll.sale[1].product_id;
          expect(responseAll.sale.length).toBe(2);
